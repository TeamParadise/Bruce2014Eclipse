...
public class VisionTargetSpotter extends Subsystem
{
    ...
    private class Scores
	{
        ...
        double aspectRatioVertical = 0;
        double aspectRatioHorizontal = 0;
    }
    ...
    public VisionTargetSpotter()
	{
		try
		{
			camera = new AxisCamera("10.11.65.11");  // get an instance of the camera
		}
		catch (Exception ex)
		{
			...
			if (filteredImage.getNumberParticles() > 0)
			{
				...
				for (int i = 0; i < verticalTargetCount; i++)
				{
					...
					for (int j = 0; j < horizontalTargetCount; j++)
					{
						...
						double horizWidth = 0, horizHeight = 0, vertWidth = 0, leftScore = 0, rightScore = 0, tapeWidthScore = 0, verticalScore = 0, total = 0;

						//Measure equivalent rectangle sides for use in score calculation
/*						horizWidth = NIVision.MeasureParticle(filteredImage.image, horizontalTargets[j], false, MeasurementType.MT_EQUIVALENT_RECT_LONG_SIDE);
						vertWidth = NIVision.MeasureParticle(filteredImage.image, verticalTargets[i], false, MeasurementType.MT_EQUIVALENT_RECT_SHORT_SIDE);
						horizHeight = NIVision.MeasureParticle(filteredImage.image, horizontalTargets[j], false, MeasurementType.MT_EQUIVALENT_RECT_SHORT_SIDE);
*/
...
*/		catch (NIVisionException ex)
	...
	{
		double rectLong = 0, height = 0;
		int targetHeight;

		//rectLong = NIVision.MeasureParticle(image.image, particleNumber, false, MeasurementType.MT_EQUIVALENT_RECT_LONG_SIDE);
    ...
    public double scoreAspectRatio(BinaryImage image, ParticleAnalysisReport report, int particleNumber, boolean vertical) throws NIVisionException
    {
        ...
        //rectLong = NIVision.MeasureParticle(image.image, particleNumber, false, MeasurementType.MT_EQUIVALENT_RECT_LONG_SIDE);
        //rectShort = NIVision.MeasureParticle(image.image, particleNumber, false, MeasurementType.MT_EQUIVALENT_RECT_SHORT_SIDE);
